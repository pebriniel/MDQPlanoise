...
function slider_save_details(){
	...
	if (isset($_POST["slider_image_url"]) || !wp_verify_nonce($_POST['sliderasso_nonce'], 'slider_asso') || $start_date || $end_date || $address_event || $list_event_asso || $start_hour_date || $end_hour_date || $desc_event_asso) {
		$openblank = 0;
