<?php echo "coucou";?>
<!-- <script src="<?= get_site_url(); ?>/wp-content/themes/maisondequartier/js/jquery.reflection.js" type="text/javascript"></script>
<script src="<?= get_site_url(); ?>/wp-content/themes/maisondequartier/js/jquery.cloud9carousel.js" type="text/javascript"></script>
<script src="<?= get_site_url(); ?>/wp-content/themes/maisondequartier/js/carousel.js" type="text/javascript"></script> -->

<!-- <script src="<?= get_site_url(); ?>/wp-content/themes/maisondequartier/js/jquery.circular-carousel.js" type="text/javascript"></script>
<script src="<?= get_site_url(); ?>/wp-content/themes/maisondequartier/js/carousel.js" type="text/javascript"></script> --> -->

<!-- <script src="<?= get_site_url(); ?>/wp-content/themes/maisondequartier/js/jquery.carouFredSel-6.0.4-packed.js" type="text/javascript"></script> --> -->
